...
extern "C" {
	...
	sgx_status_t SGX_CDECL ocall_decent_net_cnet_recv_pack(size_t* retval, void* ptr, char** msg);
	...
	sgx_status_t SGX_CDECL ocall_decent_net_cnet_send_raw(size_t* retval, void* ptr, const char* msg, size_t size);
	sgx_status_t SGX_CDECL ocall_decent_net_cnet_recv_raw(size_t* retval, void* ptr, char* buf, size_t buf_size);
