...
namespace Decent
{
	namespace Tools
	{
		...
		public:
			...
			virtual int FSeek(const size_t pos) override { return PlainFile::FSeek(pos); }
			virtual int FSeek(const size_t pos, const int origin) override { return PlainFile::FSeek(pos, origin); }
